...
struct MultipleAllelesContent6: View {
    var body: some View {
        ContentScrollableView {
            VStack(spacing: 30) {
                Text("Now, let's see which alleles are involved to blood type.")
                ...
                Text("Yes. that's why blood type inheritance is called 'Multiple Alleles'.")
                VStack(spacing: 15) {
                    Text("Except there are multiple kinds of allele, other things are same.")
